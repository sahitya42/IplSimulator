...
bat_fp = spark.read.csv('/home/vireen05/Desktop/IPL_sim/Step-1/batting.csv', header=True, inferSchema=True)
bowl_fp = spark.read.csv('/home/vireen05/Desktop/IPL_sim/Step-1/bowling.csv', header=True, inferSchema=True)
